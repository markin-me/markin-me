...
CREATE TABLE `order_orders` (
  ...
  `comment` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `address_comment` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(79, 1, 3, 42, 0, 1, '2026-02-06 10:11:09', '2026-02-06 10:11:09'),
(80, 1, 3, 48, 1, 1, '2026-02-06 10:11:09', '2026-02-06 10:11:09'),
(81, 1, 3, 40, 2, 0, '2026-02-06 10:11:09', '2026-02-06 10:11:09'),
(82, 1, 3, 52, 3, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(83, 1, 3, 41, 4, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(84, 1, 3, 50, 5, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(85, 1, 3, 46, 6, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(86, 1, 3, 43, 7, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(87, 1, 3, 51, 8, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(88, 1, 3, 9, 9, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(89, 1, 3, 8, 10, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(90, 1, 3, 14, 11, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(91, 1, 3, 3, 12, 0, '2026-02-06 10:11:10', '2026-02-06 10:11:10'),
(92, 1, 3, 45, 13, 0, '2026-02-06 10:11:11', '2026-02-06 10:11:11'),
(93, 1, 3, 49, 14, 0, '2026-02-06 10:11:11', '2026-02-06 10:11:11'),
(94, 1, 3, 44, 15, 0, '2026-02-06 10:11:11', '2026-02-06 10:11:11'),
(95, 1, 3, 29, 16, 0, '2026-02-06 10:11:11', '2026-02-06 10:11:11'),
(96, 1, 3, 39, 17, 0, '2026-02-06 10:11:11', '2026-02-06 10:11:11');
...
(39, 1, 'Тефтели с пюре', NULL, NULL, NULL, 293.34, NULL, 16.21, 6, '[\"/static/uploads/products/1/97f3015b45f4aad749bb4bae10190c93.jpg\"]', 1, 1, '2026-01-30 03:54:41', '2026-02-06 10:22:33', 6, NULL),
...
--
-- Структура таблицы `ten_store_telegram`
--

CREATE TABLE `ten_store_telegram` (
  `id` int NOT NULL,
  `tenant_id` int NOT NULL,
  `store_id` int NOT NULL,
  `telegram_chat_id` bigint DEFAULT NULL,
  `connect_token` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
-- Структура таблицы `ten_telegram_pending`
--

CREATE TABLE `ten_telegram_pending` (
  `id` int NOT NULL,
  `telegram_chat_id` bigint NOT NULL,
  `secret_key` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Индексы таблицы `ten_store_telegram`
--
ALTER TABLE `ten_store_telegram`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `connect_token_unique` (`connect_token`),
  ADD UNIQUE KEY `secret_key_unique` (`secret_key`),
  ADD UNIQUE KEY `unique_tenant_store_chat` (`tenant_id`,`store_id`,`telegram_chat_id`),
  ADD KEY `tenant_store` (`tenant_id`,`store_id`),
  ADD KEY `token_expires` (`connect_token_expires_at`);

--
-- Индексы таблицы `ten_telegram_pending`
--
...
--
-- AUTO_INCREMENT для таблицы `ten_store_telegram`
--
ALTER TABLE `ten_store_telegram`
